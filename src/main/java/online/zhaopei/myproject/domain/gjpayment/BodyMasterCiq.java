...
@XmlType(propOrder = {
	"seqNo", "guid", "managerCustomsCode", "payTime", "orderId", "payEnterpriseCode",
	"payEnterpriseName", "payNumber", "billMode", "ecpCode", "ecpName", "paymentType",
	"monetaryType", "fee", "customerFlag", "idType", "customerId", "ieType", "remark",
	"payUser", "payECode", "cbeCodeInsp", "coinInsp", "cbeCode", "cbeName", "modifyMark"
})
public class BodyMasterCiq implements Serializable {

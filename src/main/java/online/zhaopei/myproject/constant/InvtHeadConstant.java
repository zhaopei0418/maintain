...
public enum InvtHeadConstant implements Serializable {
	...
	APP_STATUS_625201("-625201"),
	APP_STATUS_625201_DESC("存在已申请单证"),
	APP_STATUS_504011("-504011"),
	APP_STATUS_504011_DESC("参数校验不通过"),
	
	CUSTOMS_STATUS_00("00"),
	CUSTOMS_STATUS_00_DESC("空"),
	CUSTOMS_STATUS_ATYPISM("010"),
	CUSTOMS_STATUS_ATYPISM_DESC("不一致"),
	CUSTOMS_STATUS_AGREEMENT("101"),
	CUSTOMS_STATUS_AGREEMENT_DESC("一致"),
	...
	static {
		...
		APP_STATUS_MAP.put(APP_STATUS_625201.value, APP_STATUS_625201_DESC.value);
		APP_STATUS_MAP.put(APP_STATUS_504011.value, APP_STATUS_504011_DESC.value);
		...
		CUSTOMS_STATUS_MAP.put(CUSTOMS_STATUS_ATYPISM.toString(), CUSTOMS_STATUS_ATYPISM_DESC.toString());
		CUSTOMS_STATUS_MAP.put(CUSTOMS_STATUS_AGREEMENT.toString(), CUSTOMS_STATUS_AGREEMENT_DESC.toString());
